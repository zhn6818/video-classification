...
save_model_path = "./ResNetCRNN/ResNetCRNN50_ckpt/"
...
for epoch in range(epochs):
    ...
    np.save('./ResNetCRNN/CRNN_epoch_training_losses50.npy', A)
    np.save('./ResNetCRNN/CRNN_epoch_training_scores50.npy', B)
    np.save('./ResNetCRNN/CRNN_epoch_test_loss50.npy', C)
    np.save('./ResNetCRNN/CRNN_epoch_test_score50.npy', D)
...
plt.ylabel('accuracy')
plt.legend(['train', 'test'], loc="upper left")
title = "./ResNetCRNN/fig_UCF101_ResNetCRNN50.png"

...
action_name_path = './ResNetBinary/UCF101actions.pkl'
save_model_path = "./ResNetBinary/ResNetBinary_ckpt/"
...
for epoch in range(epochs):
    ...
    np.save('./ResNetBinary/CRNN_epoch_training_losses.npy', A)
    np.save('./ResNetBinary/CRNN_epoch_training_scores.npy', B)
    np.save('./ResNetBinary/CRNN_epoch_test_loss.npy', C)
    np.save('./ResNetBinary/CRNN_epoch_test_score.npy', D)
...
plt.ylabel('accuracy')
plt.legend(['train', 'test'], loc="upper left")
title = "./ResNetBinary/fig_UCF101_ResNetBinary.png"
